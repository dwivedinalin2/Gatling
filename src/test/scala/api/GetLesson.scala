...
class GetLesson extends Simulation {

  //protocol
  val httpProtocol= http.baseUrl("https://api.landau.app/")

  //scenario
  val scn1=scenario("Watch Lesson Video")
    .exec(
      http("Watch Lesson Video")
        .get("/v1/course/science-for-year-2-3/lesson/plants-and-animals-in-hot-countries-1690069068")
